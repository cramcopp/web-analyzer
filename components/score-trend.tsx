  ...
  if (history.length < 2) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center gap-4 text-center">
        ...
        <p className="text-[10px] text-[#888] font-bold uppercase tracking-widest leading-relaxed max-w-[200px]">
          Nicht genügend Daten für einen Trend. Führen Sie weitere Scans durch.
        </p>
      </div>
    );
  }
