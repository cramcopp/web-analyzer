...
function ImplementationPlanModule({ plan }: { plan?: any }) {
  ...
  const PhaseCard = ({ phase, data }: { phase: string, data: any }) => (
    <div className="bg-white dark:bg-zinc-900 border border-[#E5E5E5] dark:border-zinc-800 p-6 flex flex-col gap-4 relative overflow-hidden group transition-all hover:shadow-xl hover:border-[#D4AF37]">
  ...
  return (
    <div id="implementation-plan" className="mt-20 scroll-mt-24 break-inside-avoid">
      ...
      <div className="bg-[#1A1A1A] dark:bg-zinc-950 p-10 border-t-4 border-[#D4AF37] shadow-2xl relative">
