    ...
    <div className="min-h-screen bg-[#f4f6fb] text-[#172033] dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <main>
        <section className="border-b border-[#dfe3ea] bg-white dark:border-zinc-800 dark:bg-zinc-950">
          <div className="mx-auto grid max-w-[1180px] grid-cols-1 gap-8 px-6 py-10 md:px-10 lg:grid-cols-[0.9fr_1.1fr] lg:py-12">
            <div>
              ...
              <p className="mt-5 max-w-[680px] text-[16px] font-medium leading-[1.55] text-[#526071] dark:text-zinc-300">
              ...
              <div className="hidden">
                {[
                  ...
                  <div key={String(label)} className="rounded-md border border-[#dfe3ea] bg-[#f8fafc] p-3 dark:border-zinc-800 dark:bg-zinc-900">
                    <p className="text-[10px] font-black uppercase tracking-[0.14em] text-[#7b8495]">{String(label)}</p>
                    <p className="mt-2 text-[20px] font-black text-[#172033] dark:text-zinc-100">
            ...
            <div className="hidden">
              {[
                ...
                return (
                  <article key={String(title)} className="rounded-md border border-[#dfe3ea] bg-[#f8fafc] p-5 dark:border-zinc-800 dark:bg-zinc-900">
